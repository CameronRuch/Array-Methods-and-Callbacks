...
function getWinners(array, getFinals) {
    // if home team is greater than away return home team name else return away team name 
    return getFinals(array).map(item => item['Home Team Goals'] > item['Away Team Goals'] ? 
...
function getAverageGoals(array) {
   const avgHomeGoals = array.reduce(function(acc, item){
